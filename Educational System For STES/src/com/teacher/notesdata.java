...
/**
 * Servlet implementation class notesdata
 */
@WebServlet("/notesdata")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
maxFileSize = 1024 * 1024 * 10, // 10MB
maxRequestSize = 1024 * 1024 * 50)
public class notesdata extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "INSERT INTO tblnotesdata values (?,?,?,?,?,?)";
			...
			pw.println("<html><script>alert('Notes Uploaded Sucessfully');</script><body>");
			pw.println("");
			pw.println("</body></html>");
			RequestDispatcher rd = request
					.getRequestDispatcher("/T_NotesUploadPage.jsp");
