...
/**
 * Servlet implementation class Notes_download
 */
@WebServlet("/Notes_download")
public class Notes_download extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Notes_download() {
        super();
   ...
   ResultSet result1 =statement.executeQuery("select * from tblnotesdata where fileName='"+filename+"' ") ; 
			if(result1.next())
				  {
