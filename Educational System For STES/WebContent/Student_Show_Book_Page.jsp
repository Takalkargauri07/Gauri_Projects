					...
					<div class="navbar navbar-default" role="navigation">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								...
								<li><a href=" S_ShowFeePage.jsp">Show Fee</a></li>
							...
							<div class="row second-bread">
								...
								<div class="col-md-6 text-right">
									<div class="bread">
										<ol class="breadcrumb">
											<li><a href="#">Home</a></li>
											<li class="active">Show Book Info</li>
										</ol>
									</div>
								</div>
							</div>
							...
							<div class="blog-desc">
								<div class="shop-cart">
									<div class="edit-profile">
										<form name="form1" action=loginginfo method="post">
											<table class="table">
												...
												<%
													String qcode = request.getParameter("username");
													Connection connection = Dbconn.conn();
													Statement statement = connection.createStatement();
													String stud_level = (String) session.getAttribute("stud_stdlevel");
													String section_data = (String) session
															.getAttribute("stud_section_data");
													System.out.println(stud_level);
													ResultSet resultset = statement
															.executeQuery("select * from tblbookdata where stdname='"
																	+ stud_level
																	+ "' and Section_data='"
																	+ section_data + "'");
												...
												<tr>
													...
													<td><a
														href="bookdownload?filenamedb=<%=resultset.getString("FileName")%>"><input
