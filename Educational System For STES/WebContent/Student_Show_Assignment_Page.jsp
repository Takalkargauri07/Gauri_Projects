							...
							<div class="row second-bread">
								...
								<div class="col-md-6 text-right">
									<div class="bread">
										<ol class="breadcrumb">
											<li><a href="#">Home</a></li>
											<li class="active">Show Assignment Info</li>
										</ol>
									</div>
								</div>
							</div>
											...
											<table class="table">
												...
												<%
													...
													ResultSet resultset = statement
															.executeQuery("select * from tblassignmentdata where stdname='"
																	+ stud_level
																	+ "' and Section_data='"
																	+ section_data + "'");
												...
												<tr>
													...
													<td><a
														href="assignmentdata?filenamedb=<%=resultset.getString("FileName")%>"><input
