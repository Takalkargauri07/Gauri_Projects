							...
							<div class="row second-bread">
								...
								<div class="col-md-6 text-right">
									<div class="bread">
										<ol class="breadcrumb">
											<li><a href="#">Home</a></li>
											<li class="active">Show Notices Info</li>
										</ol>
									</div>
								</div>
							</div>
										...
										<table class="table">
											...
											<tbody>
												<%
													...
													String username = (String) session.getAttribute("s_email");
													//String username="suhas";
													ResultSet resultset = statement
															.executeQuery("select * from tblstudent_doubts where Student_email_id='"
																	+ username + "'");
													while (resultset.next()) {
												%>
												<tr>
													<td><%=resultset.getString("SubjectNotices")%></td>

													<td><%=resultset.getString("MessageNotices")%></td>
