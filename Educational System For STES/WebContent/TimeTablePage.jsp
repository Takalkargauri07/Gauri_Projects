					...
					<div id="content" class="col-md-12 col-sm-12 col-xs-12">
						<div class="blog-wrapper">
							<div class="row second-bread">
								<div class="col-md-6 text-left">
									<h1>Time Table Info</h1>
								</div>
								<div class="col-md-6 text-right">
									<div class="bread">
										<ol class="breadcrumb">
											<li><a href="#">Home</a></li>
											<li class="active">Time Table Info</li>
										</ol>
									</div>
								</div>
							</div>
							...
							<div class="blog-desc">
								<div class="shop-cart">
									<div class="edit-profile">
										...
										%>
										<form role="form" action=TimeTablePage.jsp method="post">
											<div class="form-group">
												<label>Select Year</label> <select name="state"
										...
										<form role="form" action=timetableinfo method="post">
											<%
											...
											<div class="form-group">
												<label>Select Department</label> <select name="stdclass"
													id="state" size="1" class="form-control">
													<option>Selected
														Department</option>
											...
											<div class="form-group">
												<label>Select Division</label> <select class="form-control"
											...
											<div class="form-group">
												<label>Select Day</label> <select class="form-control"
													style="background-color: white; color: black;" id="txtdate"
											...
											<div class="form-group">
												<label>Subject-3</label>
												 <input type="text" name="txtSubject3"
													class="form-control" required="" />
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label>Subject-5</label>
												 <input type="text" name="txtSubject5"
													class="form-control" required="" />
											</div>
											<div class="form-group">
												<label>Subject-6</label>
												 <input type="text" name="txtSubject6"
													class="form-control" required="" />
											</div>
											...
											<div class="form-group">
												<label>Subject-7</label>
												 <input type="text" name="txtSubject7"
													class="form-control" required="" />
											</div>
											...
											<div class="form-group">
												<label>Select Class</label> <select name="stdclass"
													id="state" size="1" class="form-control">
													<option>Selected
														Department</option>
													<option value="Computer">Computer</option>
