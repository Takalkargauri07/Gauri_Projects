...
<form name="form1" action=student_doubts_add method="post">
            <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0">
             <tr style="width: 404px; ">
             <td>Select Date</td>
             <td><input type="date" class="form-control"
											data-format="dd/MM/yyyy hh:mm:ss" required="required"	name="txttime" 												placeholder="Starting Date">
