							...
							<div class="blog-desc">
								<div class="shop-cart">
									<div class="edit-profile">
										...
										<form enctype="multipart/form-data" action="notesdata"
											method="post">
											<table class="table">

												<tr style="width: 404px;">
													<td class="lable">Subject Name :</td>
													<td><input type="text" value="<%=Subject_name%>"
														readonly="readonly" name="txtSubject1"
														class="form-control" /></td>
												</tr>
												<tr style="width: 404px;">
													<td class="lable">Std Level :</td>
													<td><input type="text" value="<%=stdlevel%>"
														readonly="readonly" name="txtname"
														class="form-control" /></td>
												</tr>
												<tr style="width: 404px;">
													<td class="lable">Section Data :</td>
													<td><input type="text" value="<%=section_data%>"
														readonly="readonly" name="txtsection"
														class="form-control" /></td>
												</tr>
												<tr>
													<td width="17%"><label for="txt_Uname">Select Notes File</label></td>
													<td width="20%"><input type="file"
														class="btn btn-primary"
														name="txt_search" id="txt_search" /></td>
												</tr>
