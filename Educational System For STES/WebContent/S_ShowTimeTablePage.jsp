								...
								<div class="shop-cart">
									<div class="edit-profile">
										...
										<%
											...
											Statement stfifo3 = con.createStatement();
											ResultSet rs;
											ResultSet rs1;
											ResultSet rs2;
											...
											String levelmsg = (String) session.getAttribute("stdlevel");
											String timedata = "8:00-8:45" + "@" + "8:45-9:30" + "@"
													+ "9:30-10:00" + "@" + "10:00-10:45" + "@" + "10:45-11:30"
													+ "@" + "11:30-12:15" + "@" + "12:15-1:00";
											String[] t1 = timedata.split("@");
											if (levelmsg.equals("FE")) {
										%>
										<table class="table">

											<tr>
												<td>Standard</td>
												<td style="background-color: #ADD8E6;"><%=levelmsg%></td>
												<td>Department</td>
												<td style="background-color: #ADD8E6;"><%=classname%></td>
												<td>Division</td>
												<td style="background-color: #ADD8E6;"><%=section%></td>
												<td>Student ID</td>
												<td style="background-color: #ADD8E6;"><%=session.getAttribute("std_id")%>
												</td>
											...
											<%
												rs = stfifo2
															.executeQuery("select * from tblmastertime where classname='"
																	+ classname
																	+ "' and section_data='"
																	+ section
																	+ "'");
										...
										<%
											if (levelmsg.equals("SE")) {
										%>
										<table style="width: 60%" border="1">
											<tr>
												<td bgcolor="#F48100" colspan="8" class="bodytext03Copy1"><div
														align="center" class="bodytext">
														<strong>Show Time Table</strong>
													</div></td>
											</tr>
											<tr>
												<td></td>
