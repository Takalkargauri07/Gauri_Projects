					...
					<div id="content" class="col-md-12 col-sm-12 col-xs-12">
						<div class="blog-wrapper">
							<div class="row second-bread">
								<div class="col-md-6 text-left">
									<h1>Student Attendance Report Info</h1>
								</div>
								<div class="col-md-6 text-right">
									<div class="bread">
										<ol class="breadcrumb">
											<li><a href="#">Home</a></li>
											<li class="active">Student Attendance Report Info</li>
										</ol>
									</div>
								</div>
							</div>
							...
							<div class="blog-desc">
								<div class="shop-cart">
									<div class="edit-profile">
										...
										%>
										<form role="form" action=stud_atten method="post">
											<div class="form-group">
												<label>Select Year</label> <select name="stdlevel"
