					...
					<div class="navbar navbar-default" role="navigation">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								...
								<li><a href="Student_Show_Book_Page.jsp">Show Book</a></li>
								<li class="dropdown ttmenu-half"><a href="#"
									data-toggle="dropdown" class="dropdown-toggle">Report <b
											...
											<div class="ttmenu-content">
												<div class="row">
													<div class="col-md-6">
														<div class="box">
															<ul>
																<li><a href="StudentAttendance">Student
																		Attendance</a></li>
								...
								<li class="dropdown ttmenu-half"><a href="#"
									data-toggle="dropdown" class="dropdown-toggle">Show Data <b
										class="fa fa-angle-down"></b></a>
									<ul class="dropdown-menu">
										<li>
											<div class="ttmenu-content">
												<div class="row">
													<div class="col-md-6">
														<div class="box">
															<ul>
																<li><a href="Student_Show_Notes_Page.jsp">Show
																		Notes</a></li>
																<li><a href="Student_Show_Assignment_Page.jsp">Show_Assignment
																</a></li>
																<li><a href="Student_Assignment_Upload.jsp">Assignment
																		Upload </a></li>
															</ul>
														</div>
													</div>
								...
								<li class="dropdown ttmenu-half"><a href="#"
									data-toggle="dropdown" class="dropdown-toggle">Show Doubts
										Data <b class="fa fa-angle-down"></b>
								</a>
									<ul class="dropdown-menu">
										<li>
											<div class="ttmenu-content">
												<div class="row">
													<div class="col-md-6">
														<div class="box">
															<ul>
																<li><a href="Student_doubtsPage.jsp">Student
																		Doubts </a></li>
							...
							<ul class="nav navbar-nav navbar-right">
								<li><a class="btn btn-primary" href="LoginPage"><i
										class="fa fa-sign-in"></i> Student Page</a></li>
							</ul>
						</div>
					</div>
				</div>
...
<form role="form" action=S_ShowFeePage.jsp method="post">
											<div class="form-group">
												<label>Select Cast</label> <select name="state"
													id="countySel" size="1" class="form-control"
...
<form role="form" action=feepay method="post">
<%
...
if (state == null) {
	...
	String classname = (String) session.getAttribute("state");
	ResultSet rs = stfifo2
			.executeQuery("select * from fee where Cast_Name='"
					+ state.replace("'","")
					+ "'");
	if(rs.next())
	{
...
<div class="form-group">
											...
											<div class="form-group">
												<label>Select Year</label> <select class="form-control"
													class="form-control" id="Group1" name="section_data"
													required>
											...
											<div class="form-group">
												<label>Account No</label>
												 <input type="text" name="txtSubject1"
													class="form-control" value="987654321012" readonly="readonly" required="" />
											</div>
											<div class="form-group">
												<label>IFSC Code</label>
												 <input type="text" name="txtSubject2"
													class="form-control" value="SBI00002234" readonly="readonly" required="" />
											</div>
											<div class="form-group">
												<label>Amount Fee</label>
												 <input type="text" name="stdclass" value="<%=amount %>"
													class="form-control" required=""  readonly="readonly"/>
											</div>
											<div class="form-group">
												<label>Pay Amount</label>
												 <input type="text" name="txtSubject4"
