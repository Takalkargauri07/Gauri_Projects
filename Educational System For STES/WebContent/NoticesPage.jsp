...
<ol class="breadcrumb">
<li><a href="#">Home</a></li>
<li class="active">Notices Info</li>
</ol>
</div>
</div>
</div>
...
<form role="form" action=noticeinfo method="post">
<div class="form-group">
<label>Select Date</label>
<input type="date" class="form-control" data-format="dd/MM/yyyy hh:mm:ss" required="required"	name="txttime" placeholder="Starting Date">
</div>
<div class="form-group">
<label>Select End Date</label>
<input type="date" class="form-control" data-format="dd/MM/yyyy hh:mm:ss" required="required"	name="txtend" placeholder="End Date">
</div>
<div class="form-group">
<label>Notices Subject</label>
